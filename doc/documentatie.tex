...
\begin{document}
	...
	\begin{titlepage}
		...
		\begin{tabular}{ll}
			\textbf{Echipă:} & Cîrneală Darius, Botărel Patrik \\
	...
	\begin{enumerate}
		...
		\item \textbf{Chat}: Comunicare prin mesaje text între jucători în timpul partidei.
	\end{enumerate}
	
	\subsection{Diagrama Use-Case}
	\begin{figure}[H]
		\fakeimage{usecase\_table\_online.png}
